...
function clicar(value) {
  ...
  if (elNum && ! votoEmBranco) {
    ...
    (new Audio('audio/urna-eletronica_audio_se1.mp3')).play()
  }
}
...
function corrigir() {
  ...
  (new Audio('audio/urna-eletronica_audio_se2.mp3')).play()
  comecarEtapa()
}
...
function confirmar() {
  ...
  (new Audio('audio/urna-eletronica_audio_se3.mp3')).play()
  comecarEtapa()
}